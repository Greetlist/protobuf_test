...
class Person_PhoneNumber final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:test.Person.PhoneNumber) */ {
 public:
  Person_PhoneNumber();
...
class Person final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:test.Person) */ {
 public:
  Person();
  virtual ~Person();
...
class AddressBook final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:test.AddressBook) */ {
 public:
  AddressBook();
  virtual ~AddressBook();
